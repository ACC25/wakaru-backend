...
describe "users are denied service with invalid token" do
  it "sends error message when token is invalid" do
    ...
    email = {
      token: "akjshdfklajsdlkjfa;skjd;lfkjadf"
    }
    ...
    expect(reply["error"]).to eq("Unauthorized Access. Permission Denied.")
  end
end
